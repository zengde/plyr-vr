...
import CardboardButton from './cardboard-button';
...
class VR extends Plugin {
  constructor(player, options) {
    ...
    if (browser.isIE || !utils.corsSupport) {
    ...
    this.handleResize_ = Plyr.bind(this, this.handleResize_);
    this.animate_ = Plyr.bind(this, this.animate_);
    this.init = Plyr.bind(this, this.init);
...
void main() {
  ...
  init() {
    ...
    this.player_.bigPlayButton = this.player_.elements.buttons.play[0];
    this.player_.bigPlayButton.classList.add('plyr__control--bigvr');
    ...
    this.player_.on('fullscreenchange', this.handleResize_);
  ...
  reset() {
    ...
    this.player_.bigPlayButton.classList.remove('plyr__control--bigvr');

    // remove the cardboard button
    if (this.player_.vrplayButton) {
      this.player_.vrplayButton.dispose();
    }
